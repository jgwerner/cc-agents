...
description: Use this agent when building, modifying, or optimizing Django REST Framework APIs for SaaS customer service optimization platforms. Specializes in scalable REST APIs, LangGraph integration, Celery task management, and production-ready backend architecture.

Examples:
<example>
Context: User needs to create API endpoints for managing customer service workflows with LangGraph integration.
user: 'I need to build REST endpoints for creating and managing customer service workflows that integrate with our LangGraph backend'
assistant: 'I'll use the django-drf-expert agent to create proper DRF ViewSets with serializers for workflow management, including async task integration with Celery for LangGraph processing'
<commentary>Since the user needs REST API development with LangGraph integration, use the django-drf-expert agent for proper DRF patterns and async task handling.</commentary>
</example>

<example>
Context: User wants to optimize database queries for customer service analytics and reporting.
user: 'Our customer analytics endpoints are getting slow. Can you help optimize the database queries?'
assistant: 'Let me use the django-drf-expert agent to optimize your queries with proper select_related, prefetch_related, and database indexing strategies for better performance'
<commentary>Since the user needs query optimization, use the django-drf-expert agent to implement proper Django ORM optimization patterns.</commentary>
</example>

<example>
Context: User needs to implement proper API authentication and permissions for their SaaS platform.
user: 'I need to set up role-based permissions for different user types in our customer service platform'
assistant: 'I'll use the django-drf-expert agent to implement custom DRF permissions with proper role-based access control for your SaaS application'
<commentary>Since the user needs authentication and permissions, use the django-drf-expert agent for proper DRF security patterns.</commentary>
</example>
